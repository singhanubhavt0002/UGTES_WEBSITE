        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            <motion.div 
               ...
               className="glass-panel p-8 rounded-2xl hover-card"
            >
          ...
          <motion.div 
             ...
             className="lg:col-span-2 glass-panel rounded-3xl p-8 md:p-12 shadow-2xl"
          >
            ...
            {status === 'success' ? (
              <motion.div 
                 ...
                 className="bg-green-50 border border-green-200 text-green-700 p-8 rounded-2xl text-center flex flex-col items-center"
              >
