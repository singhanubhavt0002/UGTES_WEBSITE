...
export const COMPANY_FULL_NAME = "Uniglobe Traders & Engineers (UGTES)";
export const DOMAIN = "ugtes.com";
export const CONTACT_EMAIL = "info@ugtes.com";
export const CONTACT_PHONE = "+91 9315590249";
export const ADDRESS = "501 A, Prateek The Royal Cliff Crossing Republik, Ghaziabad – 201016, India";
