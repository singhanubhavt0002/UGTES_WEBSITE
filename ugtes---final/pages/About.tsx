      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Values */}
            <div className="bg-white p-8 rounded-xl shadow-md border-t-4 border-accent-500 lg:col-span-1 md:col-span-2 lg:col-start-auto md:col-start-auto">
               <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mb-6 text-primary-900">
                 <Award size={24} />
               </div>
